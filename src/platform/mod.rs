...
pub trait Platform<T> {
	...
	fn create_bitmap(&'static self, data: *mut Color, width: Axis, height: Axis) -> PlatformBitmap<T>;
	...
	fn draw_bitmap(&self, bitmap: PlatformBitmap<T>, dx: i32, dy: i32, src_x: i32, src_y: i32, w: i32, h: i32);
